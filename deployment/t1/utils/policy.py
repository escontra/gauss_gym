...
class Policy:
  ...
  def _init_inference_variables(self):
    self.default_dof_pos = np.array(
      self.onboard_cfg['common']['default_qpos'], dtype=np.float32
    )
    ...
    self.policy_interval = (
      self.onboard_cfg['common']['dt'] * self.cfg['control']['decimation']
    )
  ...
  def inference(
    ...
    self.dof_targets[11:] += self.actions
