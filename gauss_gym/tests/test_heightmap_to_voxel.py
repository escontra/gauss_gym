...
from gauss_gym.utils import voxel
...
def test_heightmap_to_voxels():
  ...
  heightmap_torch = voxel.voxels_to_heightmap(
    occupancy_grid_torch, centroid_grid_torch, min_height, max_height
  )
  ...
  print(f'Unsaturated mask:\n{unsaturated_mask.cpu().numpy()}')
